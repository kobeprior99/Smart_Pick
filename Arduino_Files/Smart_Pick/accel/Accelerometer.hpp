...
public:
    ...
    bool Setup() {
      ...
      // 780 mg per lsb
      writeRegister(REG_ACT_THRSH, 0xb); // adjust sensitivity activity must go above and below the threshold 6 LSBs because I recorded 30 ish baseline from steady state
    ...
    int32_t readAccelMagnitude() {
        ...
        return (int32_t)y;//raw LSB needs to be converted with 49 mg/LSB in post
    }
